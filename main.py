...
drawer= Koch.Koch(Coords2D(1080,1920), 3, 1, field_size=Coords2D(200,200),border=True,side=7,max_iterations=10)
#drawer=Gosper.Gosper(Coords2D(1080,1920), 30, 240, field_size=Coords2D(20,20),border=True,init_point=Coords2D(0,10))

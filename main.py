...
#drawer = GameOfLifeDrawer.GameOfLifeDrawer(Coords2D(1080,1920),60,8,Coords2D(200,200), True,births=[3,7,8],stables=[2,3,5,6,7,8],initial_state=init_state)
...
#drawer= Koch.Koch(Coords2D(1080,1920), 3, 1, field_size=Coords2D(30,30),border=True,side=3,max_iterations=0)
drawer=Gosper.Gosper(Coords2D(1080,1920), 30, 3600, field_size=Coords2D(50,50),border=True,init_point=Coords2D(15,20))
